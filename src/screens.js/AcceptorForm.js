...
const AcceptorForm = () => {
 ...
 const submitClicked = () =>{
    ...
    const usersRef = firebase.firestore().collection('Acceptors')
    let  obj= {
      userUid,country,state,address,contactNumber,age,city,contantNo,maitalStatus,hospital,name,blood,status:"acceptor"
    }
    usersRef
    .doc(userUid)
    .set(obj)
